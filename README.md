...
**JGTale (Tales of Bori VR)** 은 한국 전통 악기인 장구를 Meta Quest VR 환경에서 실제처럼 연주할 수 있는 리듬 게임입니다. 사내 제작 Rhythm Editor에서 제작된 악보를 기반으로 음악에 맞춰 장구를 연주하며, 전통 음악과 현대 VR 기술의 만남을 경험할 수 있습니다.
